...
$(document).ready(function() {
  ...
  // BV.init();
  // BV.show([
  //     { type: "video/mp4",  src: "~/Content/app-assets/videos/481479901.mp4" },
  //     { type: "video/webm", src: "~/Content/app-assets/videos/481479901.webm" },
  //     { type: "video/ogg",  src: "~/Content/app-assets/videos/481479901.ogv" }
  // ]);
});
