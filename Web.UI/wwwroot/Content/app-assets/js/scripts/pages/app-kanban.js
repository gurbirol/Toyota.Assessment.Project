...
$(document).ready(function () {
  ...
  var kanban_board_data = [{
      ...
      item: [{
          ...
          attachment: 3,
          users: [
            "~/Content/app-assets/images/portrait/small/avatar-s-11.png",
            "~/Content/app-assets/images/portrait/small/avatar-s-12.png"
          ]
        },
        {
          id: "12",
        ...
        },
        {
          ...
          attachment: 4,
          users: [
            "~/Content/app-assets/images/portrait/small/avatar-s-1.png",
            "~/Content/app-assets/images/portrait/small/avatar-s-18.png"
          ]
        },
        {
          id: "14",
          ...
          attachment: 2,
          users: [
            "~/Content/app-assets/images/portrait/small/avatar-s-26.png",
            "~/Content/app-assets/images/portrait/small/avatar-s-16.png"
          ]
        },
        {
          id: "15",
    ...
    },
    {
      ...
      item: [{
        ...
        },
        {
          ...
          comment: 8,
          users: [
            "~/Content/app-assets/images/portrait/small/avatar-s-24.png",
            "~/Content/app-assets/images/portrait/small/avatar-s-14.png"
          ]
        },
        {
          id: "23",
    ...
    },
    {
      ...
      item: [{
          ...
          comment: 10,
          users: [
            "~/Content/app-assets/images/portrait/small/avatar-s-20.png",
            "~/Content/app-assets/images/portrait/small/avatar-s-22.png",
            "~/Content/app-assets/images/portrait/small/avatar-s-13.png"
          ]
        },
        {
          id: "32",
        ...
        },
        {
          ...
          users: [
            "~/Content/app-assets/images/portrait/small/avatar-s-1.png",
            "~/Content/app-assets/images/portrait/small/avatar-s-2.png"
          ]
        }
      ]
    }
