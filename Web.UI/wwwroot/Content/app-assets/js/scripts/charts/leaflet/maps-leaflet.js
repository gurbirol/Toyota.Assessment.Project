...
$(document).ready(function () {
    ...
    var customIconBlue = L.icon({
        iconUrl: '~/Content/app-assets/images/map/leaflet/customIcons/map-marker-blue.png',
        iconSize: [52, 52], // size of the icon
        iconAnchor: [22, 94], // point of the icon which will correspond to marker's location
        popupAnchor: [-3, -76] // point from which the popup should open relative to the iconAnchor
    });
    var customIconPink = L.icon({
        iconUrl: '~/Content/app-assets/images/map/leaflet/customIcons/map-marker-pink.png',
        iconSize: [52, 52], // size of the icon
        iconAnchor: [22, 94], // point of the icon which will correspond to marker's location
        popupAnchor: [-3, -76] // point from which the popup should open relative to the iconAnchor
    });
